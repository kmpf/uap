...
#$ -pe smp #{CORES}           # request the "smp" parallel environment and up to N slots
...
#$ -m eas                     # e-mail notification at following events: End of job, Abortion of job and Suspension of job
#$ -M #{EMAIL}                # e-mail notification
#$ -l h_rt=96:00:00           # runtime of your job
#$ -l m_core=#{CORES}         # use only nodes where all 8 core are available
