...
class Fastqc(AbstractStep):
    ...
    def __init__(self, pipeline):
        ...
        self.add_option('casava', bool, optional=True,
        ...
        self.add_option('java', str, optional=True,
        ...
        self.add_option('nogroup', bool, optional=True,
        ...
        self.add_option('contaminants', str, optional=True,
        ...
        self.add_option('adapters', str, optional=True,
                        description="Specifies a non-default file which contains the list of "
        ...
        self.add_option('limits', str, optional=True,
        ...
        self.add_option('kmers', int, optional=True,
                        ...
                        "7 if not specified.")
        self.add_option('dir', str, optional=True,
    ...
    def runs(self, run_ids_connections_files):
        ...
        options = ['casava', 'nofilter', 'java', 'nogroup', 'format', 'contaminants',
                   'adapters', 'limits', 'kmers', 'dir']
