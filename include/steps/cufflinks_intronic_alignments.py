...
class CuffLinks(AbstractStep):
    '''
    Cufflinks with -j/--pre-mrna-fraction <0.0-1.0> option set to 0.0, i.e. none of the intronic alignments is discarded. 
    '''
        ...
        with process_pool.ProcessPool(self) as pool:
            with pool.Pipeline(pool) as pipeline:
                ...
                cufflinks = [
                    ...
                    '-p', cores,
		    '-j', '0.0', # -j/--pre-mrna-fraction <0.0-1.0> -- do not discard any alignments in introns   
