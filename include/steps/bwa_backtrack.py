...
class BwaBacktrack(AbstractStep):
    ...
    def __init__(self, pipeline):
        ...
        self.add_option('aln-i', int, optional = True,
                        ...
                        "the ends [5]")
        self.add_option('aln-l', int, optional = True,
        ...
        self.add_option('aln-q', int, optional = True,
                        ...
                        "read down to argmax_x{\sum_{i=x+1}^l(INT-q_i)} if "
        ...
        self.add_option('aln-b', bool, optional = True,
        ...
        self.add_option('aln-1', bool, optional = True,
        ...
        self.add_option('samse-n', int, optional = True,
        ...
        self.add_option('sampe-a', int, optional = True,
                        ...
                        "[500]")
        self.add_option('sampe-o', int, optional = True,
    ...
    def runs(self, run_ids_connections_files):
        ...
        options_bwa_aln = ['aln-n', 'aln-o', 'aln-e', 'aln-d', 'aln-i', 'aln-l',
                           ...
                           'aln-N', 'aln-q', 'aln-I', 'aln-B', 'aln-b', 'aln-0',
                           'aln-1', 'aln-2']
